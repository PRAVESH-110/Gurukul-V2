  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
        <Link to="/create-course" className="group flex flex-col items-center justify-center p-6 bg-white rounded-xl shadow-sm border border-gray-100 hover:shadow-md hover:border-primary-200 transition-all duration-200">
        ...
        <Link to="/create-community" className="group flex flex-col items-center justify-center p-6 bg-white rounded-xl shadow-sm border border-gray-100 hover:shadow-md hover:border-primary-200 transition-all duration-200">
        ...
        {dashboard?.user?.role !== 'admin' && (
          <Link to="/upload-video" className="group flex flex-col items-center justify-center p-6 bg-white rounded-xl shadow-sm border border-gray-100 hover:shadow-md hover:border-green-200 transition-all duration-200">
        ...
        <Link to="/manage-courses" className="group flex flex-col items-center justify-center p-6 bg-white rounded-xl shadow-sm border border-gray-100 hover:shadow-md hover:border-orange-200 transition-all duration-200">
        ...
        <Link to="/analytics" className="group flex flex-col items-center justify-center p-6 bg-white rounded-xl shadow-sm border border-gray-100 hover:shadow-md hover:border-blue-200 transition-all duration-200">
          ...
          <div className="p-6">
            {dashboard?.createdCourses?.length > 0 ? (
              ...
              <div className="text-center py-12">
                ...
                <Link to="/create-course" className="btn-primary text-sm">
          ...
          <div className="p-6">
            {dashboard?.createdCommunities?.length > 0 ? (
              ...
              <div className="text-center py-12">
                ...
                <Link to="/create-community" className="btn-primary text-sm">
